...
bbregFile                   = fullfile(params.sessionDir,boldDirs{runNum},bbregName); % registration file
areaOutFile                 = fullfile(params.sessionDir,boldDirs{runNum},areaOutName);
system(['mri_vol2vol --mov ' fullfile(params.sessionDir,boldDirs{runNum},[params.func '.nii.gz']) ...
...
switch roiType
    case {'V1' 'V2V3'}
        ...
        bbregFile           = fullfile(params.sessionDir,boldDirs{runNum},bbregName); % registration file
        eccOutFile          = fullfile(params.sessionDir,boldDirs{runNum},eccOutName);
        system(['mri_vol2vol --mov ' fullfile(params.sessionDir,boldDirs{runNum},[params.func '.nii.gz']) ...
