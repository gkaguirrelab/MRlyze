function create_fine_template_varexp_scripts(session_dir,outDir,runs,email)

% Creates shell scripts for running 'calc_fine_template_varexp' on the UPenn
% cluster.
%
%   Usage:
%   create_fine_template_varexp_scripts(session_dir,outDir,runs,email)
%
%   Example:
    ...
    for i = 1:5
        for j = 1:5
            for k = 1:5
                ...
                matlab_string = ([...
                    'calc_fine_template_varexp(''' session_dir ''',' ...
