...
%     design_file = 'feat_higher_level_2feat_5copes_template.fsf';
%
...
if ~exist('design_file','var')
    design_dir = which('feat_higher_level_2feat_5copes');
    design_dir = fileparts(design_dir);
    design_file = fullfile(design_dir,'feat_higher_level_2feat_5copes_template.fsf');
end
%% Add to log
...
outname = [func '.feat_higher_level_2feat_5copes.fsf'];
