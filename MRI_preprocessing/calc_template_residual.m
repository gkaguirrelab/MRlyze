function [residualSS,V1inds,V2inds,V3inds] = calc_template_residual(session_dir,runs,hemi,template)
...
%
%   Usage:
%   [residualSS,V1inds,V2inds,V3inds] = calc_template_residual(session_dir,runs,hemi,template)
%
